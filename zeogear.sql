...
--
-- Host: localhost    Database: zeogear
-- ------------------------------------------------------
...
CREATE TABLE `employees` (
  ...
  `job_title` varchar(16) DEFAULT NULL,
...
CREATE TABLE `orders_products` (
  ...
  CONSTRAINT `orders_products_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`),
  CONSTRAINT `orders_products_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_warehouse` (
  ...
  CONSTRAINT `product_warehouse_ibfk_1` FOREIGN KEY (`warehouse_ID`) REFERENCES `warehouses` (`warehouse_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
